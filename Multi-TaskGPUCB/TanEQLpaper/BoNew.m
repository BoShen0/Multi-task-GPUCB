...
No=Inf; 
noiselevels=[0.1]; %\rho
lnoiselevels=length(noiselevels); nostart=1; options=optimoptions(@patternsearch,'MaxIter',10000,'TolFun',10^-9);

for NL=1:lnoiselevels
n0=10; nfinal=30; dxz=4; nadd=nfinal-n0; nodesigns=5;
...
QuadPoints=([-sqrt(3/7+2/7*sqrt(6/5))  sqrt(3/7-2/7*sqrt(6/5)) ]+1)'/2;
...
%% show the performance for all runs
